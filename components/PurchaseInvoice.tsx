  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-6xl mx-auto border border-gray-100 animate-in fade-in relative dynamic-layouts">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-blue-50/20 rounded-[2rem] border mb-6">
        ...
        <div><label className="block text-[10px] font-black text-blue-900/40 uppercase tracking-[0.2em] mb-1">Vendor Bill #</label><input type="text" value={invoiceNo} onChange={e => setInvoiceNo(e.target.value)} className="w-full p-3 border border-blue-100 rounded-xl bg-white text-blue-600 font-mono font-black text-xs text-center shadow-xs" /></div>
          ...
          <table className="w-full text-left border-collapse min-w-[1000px] print:min-w-full">
            <thead className="bg-blue-50/30 border-b text-gray-400 font-black text-[10px] uppercase tracking-widest">
              <tr>
                ...
                <th className="p-5 w-10 no-print-el"></th>
              </tr>
            </thead>
